...
> No extra variable needed, but has overflow risk ⚠️
...
| Pros | Cons |
|------|------|
| ✅ No extra variable | ⚠️ **Integer overflow** risk for large values |
| | ⚠️ Precision issues with float/double |
...
| | ⚠️ Precision loss with floating-point |
...
| ✅ Looks cool in interviews 😎 | ⚠️ Less readable |

> ⚠️ **Gotcha:** Agar `a` aur `b` same variable hain (same memory location), XOR swap se dono **0** ho jaayenge!
> ```java
> int[] arr = {5};
...
|--------|-------------|---------------|-----------|------------|----------|
| Temp Variable | 1 variable | ✅ None | ✅ | ✅ | ⭐⭐⭐ |
| Add/Subtract | None | ❌ Yes | ✅ | ⚠️ | ⭐⭐ |
| Mul/Divide | None | ❌ Yes | ❌ | ❌ | ⭐ |
| XOR | None | ✅ None | ✅ | ❌ | ⭐⭐ |
...
> ⚠️ These are clever tricks but **not recommended** for production code — readability matters!

---

[⬅️ Back to Index](./README.md) | [Next: Quick Revision ➡️](./16-quick-revision.md)
