...
> ⚠️ **Single quotes** = character literal, **Double quotes** = String literal
> ```java
> 'A'    → char
> "A"    → String
> ```
...
### ⚠️ Constant vs Variable Assignment
...
[⬅️ Back to Index](./README.md) | [Next: Strings ➡️](./13-strings.md)
