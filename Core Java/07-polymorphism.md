...
### Note: Sirf Return Type Change ≠ Overloading
...
[Previous: Abstract Class & Interface](./06-abstract-class-and-interface.md) · [Back to Core Java Index](./README.md) · [Next: Access Modifiers](./08-access-modifiers.md)
