...
> Note: Invalid index access karne par **`ArrayIndexOutOfBoundsException`** milta hai.
...
### Note: NullPointerException Trap
...
[Back to Core Java Index](./README.md) · [Next: Variables & Type Casting](./02-variables-and-typecasting.md)
